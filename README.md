...
[LinkedIn](https://linkedin.com/in/glconde) · [Stack Overflow](https://stackoverflow.com/users/4729261/boredgames)
...
| INT-P2 Movie App | Spring Boot, Next.js, MySQL, AWS | Team project, backend work, deployment exposure | [Repo](https://github.com/glconde/intp-p2) |
| ETL / BI Project | Python, pandas, SQL | Data cleanup, transformation, reporting mindset | [Repo](https://github.com/glconde/etl-bi) |
...
| Project | Stack | What it shows | Link |
|---|---|---|---|
| Job App Tracker | .NET Core, Vue | Vue migration of the original Angular/.NET job tracking application. | [Repo](https://github.com/glconde-labs/job-app-tracker-vue) | 
| ETL Pipeline | Python, Pandas, MySQL, Docker | An ETL pipeline demo | [Repo](https://github.com/glconde/etl-pipeline) |
| Reddit Desktop Emoji Picker | JavaScript, MV3 | A chrome extension that provides an emoji picker for Reddit desktop | [Repo](https://github.com/glconde/reddit-emoji-picker) |
| Data Processor | C++ | A simulation of data processing workflow similar to those used in engineering and inspection | [Repo](https://github.com/glconde/cpp-data-processor) |
